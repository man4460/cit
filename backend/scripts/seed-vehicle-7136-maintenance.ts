/**
 * นำเข้าประวัติการบำรุงรักษา — รถทะเบียน ฮล 7136 กทม. (จากตารางประวัติการซ่อม)
 * รัน: npm run seed:vehicle7136-maint
 */
...
const MAINTENANCE_ROWS: { date: string; detail: string; cost: string }[] = [
  ...
  { date: "2023-10-03T12:00:00.000Z", detail: "เปลี่ยนโช๊คประตูหลัง", cost: "10313.73" },
  ...
  { date: "2024-05-14T12:00:00.000Z", detail: "เปลี่ยนใบปัดน้ำฝน", cost: "1170.53" },
];
