...
export function WorkCategoryGroupMasterModal({
  open,
  onClose,
  onChanged,
}: {
  ...
  const apiPath = "/api/work-category-groups";
  ...
  return (
    <Modal open={open} onClose={onClose} title="กลุ่มประเภทการทำงาน (เพิ่ม / แก้ไข / ลบ)">
